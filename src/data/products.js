// VogueVista Product Dataset - Enhanced with Multiple Images
export const products = [
    ...
    {
        id: "men-sweater-002",
        name: "V-Neck Pullover Collection",
        category: "Sweaters",
        gender: "Men",
        price: 1999,
        images: [
    ...
    // WOMEN - SWEATERS (10 products)
    {
        id: "women-sweater-001",
        name: "Giraffe Pattern Sweater",
        category: "Sweaters",
        gender: "Women",
        price: 2499,
...
export const genders = [
    ...
    { id: "men", name: "Men", count: products.filter(p => p.gender === "Men").length },
    { id: "women", name: "Women", count: products.filter(p => p.gender === "Women").length }
];

// Category filters organized by gender
export const categories = {
    all: [
        { id: "all", name: "All Products", count: products.length }
    ],
    men: [
        { id: "denim", name: "Denim", count: products.filter(p => p.gender === "Men" && p.category === "Denim").length },
        { id: "jackets", name: "Jackets & Vests", count: products.filter(p => p.gender === "Men" && p.category === "Jackets").length },
        { id: "shirts", name: "Shirts & Polos", count: products.filter(p => p.gender === "Men" && p.category === "Shirts").length },
        { id: "sweaters", name: "Sweaters", count: products.filter(p => p.gender === "Men" && p.category === "Sweaters").length }
    ],
    women: [
        ...
        { id: "skirts", name: "Skirts", count: products.filter(p => p.gender === "Women" && p.category === "Skirts").length },
        { id: "sweaters", name: "Sweaters", count: products.filter(p => p.gender === "Women" && p.category === "Sweaters").length }
    ]
};
